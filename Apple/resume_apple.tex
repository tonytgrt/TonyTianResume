...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{GPA: 3.78 | Relevant Courses: GPU Programming, 3D Modeling, Advanced Rendering, Computer Animation, Game Design Practicum, UI/UX Design,  Operating Systems Implementation, Data Structures \& Algorithms}
      \resumeItemListEnd
...
\resumeProjectHeading
          {\textbf{Metal Liquid Glass Renderer} $|$ \emph{Metal, MSL, Objective-C++}}{Feb 2026}
          \resumeItemListStart
          ...
          \resumeItem{GitHub Repo: \href{https://github.com/tonytgrt/MetalRenderer}{\uline{github.com/tonytgrt/MetalRenderer}}}
          \resumeItemListEnd
...
\resumeProjectHeading
      ...
      \resumeItem{Implemented Quad-Optimized Low-Discrepancy Sequences (QOLDS) from SIGGRAPH 2024, engineering base-3 Sobol' generator with Owen scrambling across 47 dimensions, achieving +2.57 dB PSNR and 44.7\% MSE reduction vs traditional PCG sampling at 512 SPP with $<1\%$ performance overhead}
...
% \resumeProjectHeading
%       {\textbf{Vulkan Grass Renderer - Physically Based Grass Simulation} $|$ \emph{Vulkan, GLSL, C++}}{Oct 2025 -- Nov 2025}
%       \resumeItemListStart
...
\resumeProjectHeading
      {\textbf{WebGPU Renderer - Real-time Renderer on Web} $|$ \emph{WebGPU, TypeScript, WGSL}}{Sep 2025 -- Oct 2025}
      \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \textbf{Programming}{: C++, CUDA, GLSL, WGSL, MSL, Python, Parallel algorithms, Memory management} \\
    \textbf{Graphics/Rendering}{: NSight Profiling, Path Tracing, Deferred Rendering, Rasterization, Animation systems, PBR} \\
    \textbf{Tools/APIs}{: Unreal, Unity, Maya, Metal, Nvidia NSight, WebGPU, Vulkan, Visual Studio, Qt, OpenGL, Git, CMake}
    }}
 \end{itemize}
