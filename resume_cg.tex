...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{GPA: 3.79 | Relevant Courses: GPU Programming, 3D Modeling, Advanced Rendering, Computer Animation, UI/UX Design, Procedural Graphics, Operating Systems Implementation, Data Structures \& Algorithms}
      \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \textbf{Programming}{: C++, Objective-C, CUDA, MSL, GLSL, WGSL, SwiftUI, TypeScript, Java, Python, Bash} \\
    \textbf{Graphics/Rendering}{: UI Compositing, GPU Profiling, Path Tracing, Deferred Rendering, Animation systems, PBR} \\
    \textbf{Tools/APIs}{: XCode, Metal, Unreal, Unity, Maya, Nvidia NSight, WebGPU, Vulkan, Visual Studio, Qt, OpenGL}
    }}
 \end{itemize}
