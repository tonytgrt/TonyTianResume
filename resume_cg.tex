...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \textbf{Programming}{: C++, Metal, Objective-C, CUDA, GLSL, WGSL, MSL, SwiftUI, TypeScript, Bash} \\
    \textbf{Graphics/Rendering}{: UI Compositing, GPU Profiling, Path Tracing, Deferred Rendering, Animation systems, PBR} \\
    \textbf{Tools/APIs}{: XCode, Unreal, Unity, Maya, Nvidia NSight, WebGPU, Vulkan, Visual Studio, Qt, OpenGL, Git, CMake}
    }}
 \end{itemize}
